# API Contract: Frontend-Backend Integration for Task Management

## Overview
This document specifies the API contract for the frontend-backend integration for task management, following the RESTful pattern `/api/{user_id}/tasks` and requiring JWT authentication.
